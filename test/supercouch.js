...
describe('SuperCouch', function () {
  ...
  describe('requests', function () {
    ...
    it('will return error for bad request', function (done) {
      couch
        .request('delete', '/nonexistantdb/1234')
        .end(function (err, res) {
          expect(err).to.exist;
          expect(err).to.be.instanceof(supercouch.CouchError);
          expect(err).to.have.property('code', 'ENOT_FOUND');
          done();
        });
    });
  ...
  describe('db management', function () {
